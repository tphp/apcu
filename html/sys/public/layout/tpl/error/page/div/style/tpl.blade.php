<style>
    ...
    body{font:14px/1.5 Helvetica,Sans-serif;min-width:600px;}
    :focus{outline:0}
    ...
    .error-page{background:#f0f1f3;height: 100vh}
    .error-page-container{position:relative;z-index:1;padding-top: 80px;}
